...
class DarkColors implements ThemeColorsBase<Partial<ThemeRichColor>> {
  ...
  background = {
    ...
    secondary: nortechPalette.backgroundColorDark
      ...
      : palette.gray15,
    elevated: nortechPalette.backgroundColorDark
      ? updatedHexColor(nortechPalette.backgroundColorDark, 0.1)
      : palette.gray15,
  };
...
class LightColors implements ThemeColorsBase<Partial<ThemeRichColor>> {
  ...
  background = {
    ...
    elevated: nortechPalette.backgroundColor ? updatedHexColor(nortechPalette.backgroundColor, 0.05) : palette.white,
  };
...
const nortechPalette = {
  primaryColor:
    ...
    (typeof window !== 'undefined' && (window as any).nortechCustomization?.primaryColor),
  primaryColorDark:
    (typeof process !== 'undefined' && process.env.PRIMARY_COLOR_DARK) ||
    (typeof window !== 'undefined' && (window as any).nortechCustomization?.primaryColorDark),
  warnColor:
    (typeof process !== 'undefined' && process.env.WARN_COLOR) ||
    (typeof window !== 'undefined' && (window as any).nortechCustomization?.warnColor),
  warnColorDark:
    (typeof process !== 'undefined' && process.env.WARN_COLOR_DARK) ||
    (typeof window !== 'undefined' && (window as any).nortechCustomization?.warnColorDark),
  backgroundColor:
    (typeof process !== 'undefined' && process.env.BACKGROUND_COLOR) ||
    (typeof window !== 'undefined' && (window as any).nortechCustomization?.backgroundColor),
  backgroundColorDark:
    (typeof process !== 'undefined' && process.env.BACKGROUND_COLOR_DARK) ||
    (typeof window !== 'undefined' && (window as any).nortechCustomization?.backgroundColorDark),
  fontColor:
    (typeof process !== 'undefined' && process.env.FONT_COLOR) ||
    (typeof window !== 'undefined' && (window as any).nortechCustomization?.fontColor),
  fontColorDark:
    (typeof process !== 'undefined' && process.env.FONT_COLOR_DARK) ||
    (typeof window !== 'undefined' && (window as any).nortechCustomization?.fontColorDark),
};
